# Run as Administrator. Block user 'souji' from launching Ollama.
...
$userStart   = "C:\Users\souji\AppData\Roaming\Microsoft\Windows\Start Menu\Programs"
...
Write-Host "Done. Test from 'souji' account: Ollama should be blocked."
